...
const NAV_ITEMS = [
  ...
  { to: '/admin/batches', label: 'Manage Batches', icon: BookOpen },
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
        <div className="bg-white rounded-2xl border border-red-100 p-8 max-w-md w-full text-center shadow-lg">
          ...
          <p className="text-gray-500 text-sm mb-6">You need Super Admin privileges to access this panel.</p>
          <button
            onClick={() => navigate('/')}
      ...
      <div className="p-5 border-b border-white/[0.06]">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-white/30 mt-0.5">Admin Panel</p>
          </div>
          {isMobile && (
      ...
      <div className="p-4 border-t border-white/[0.06]">
        <div className="flex items-center gap-3 mb-3 px-1">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-xs font-bold text-white/80 truncate">{user?.displayName || user?.name || 'Admin'}</p>
            <p className="text-[10px] text-brand-orange font-semibold uppercase tracking-wider">Super Admin</p>
          </div>
        </div>
        <button
