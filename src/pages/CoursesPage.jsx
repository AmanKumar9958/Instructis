...
const CoursesPage = () => {
  ...
  return (
    <section className="w-full rounded-3xl bg-linear-to-br from-emerald-50 via-white to-cyan-50 p-4 shadow-xl shadow-stone-200 sm:p-6 lg:p-10 dark:from-emerald-950 dark:via-gray-900 dark:to-cyan-950 dark:shadow-none">
      <div className="mx-auto w-full max-w-6xl">
        ...
        <div className="mt-8 grid gap-5 lg:grid-cols-3">
          {popularCourses.map((course, i) => (
            <Reveal key={course.title} direction="up" delay={i * 100}>
              <article
                className="rounded-2xl border border-emerald-100 bg-white p-5 shadow-sm transition hover:-translate-y-1 hover:shadow-md dark:border-emerald-900 dark:bg-gray-800"
              >
              ...
              <section className="rounded-2xl bg-white p-6 shadow-sm dark:bg-gray-800">
                ...
                <ul className="mt-4 space-y-3">
                  {courses.map((course) => (
                    <li
                      key={course}
                      className="rounded-xl border border-emerald-100 bg-emerald-50/60 px-4 py-3 text-sm text-neutral-700 sm:text-base dark:border-emerald-900 dark:bg-emerald-900/20 dark:text-neutral-300"
                    >
                      {course}
                    </li>
                  ))}
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-3">
              {quotes.map((quote, i) => (
                <Reveal key={quote} direction="scale" delay={i * 100}>
                  <blockquote
                    className="rounded-2xl border-l-4 border-emerald-500 bg-emerald-50 p-4 text-sm italic text-neutral-700 sm:text-base dark:bg-emerald-900/20 dark:text-neutral-300"
                  >
                    "{quote}"
                  </blockquote>
                </Reveal>
        ...
        <Reveal>
          <div className="mt-8 rounded-2xl bg-emerald-900 p-6 text-white shadow-sm dark:bg-emerald-950">
            ...
            <div className="mt-5 rounded-2xl bg-emerald-800 p-5 sm:p-6 dark:bg-emerald-900">
          ...
          <div className="mt-8 rounded-2xl bg-white p-6 shadow-sm dark:bg-gray-800">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <button className="rounded-full border border-emerald-600 px-5 py-2.5 text-sm font-semibold text-emerald-700 transition hover:bg-emerald-50 sm:text-base dark:border-emerald-500 dark:text-emerald-400 dark:hover:bg-emerald-900/20">
                  Talk to Counsellor
                </button>
              </div>
            </div>
